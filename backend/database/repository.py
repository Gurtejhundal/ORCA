...
class Repository:
    ...
    async def save_observations(self, values: list[Observation]) -> None:
        ...
        try:
            ...
            logger.warning('failed_to_save_observations: %s', exc)
    ...
    async def save_pfz(self, zones: list[Zone]) -> None:
        ...
        try:
            ...
            self.db.mark_unavailable(str(exc))
            logger.warning('failed_to_save_pfz: %s', exc)
    ...
    async def get_session(self, session_id: str) -> dict | None:
        ...
        try:
            ...
            self.db.mark_unavailable(str(exc))
            logger.warning('failed_to_get_session: %s', exc)
            return None
    ...
    async def save_session(self, session_id: str, language: str = 'en',
        ...
        try:
            ...
            self.db.mark_unavailable(str(exc))
            logger.warning('failed_to_save_session: %s', exc)
    ...
    async def save_agent_run(self, session_id: str, query: str, intent: str | None = None,
        ...
        try:
            ...
            self.db.mark_unavailable(str(exc))
            logger.warning('failed_to_save_agent_run: %s', exc)
        return identifier
