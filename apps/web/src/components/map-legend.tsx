...
export function MapLegend({ language = 'en' }: { language?: 'en' | 'hi' }) {
  ...
  return (
    <div className="absolute bottom-4 right-4 z-20 bg-[#0f1923]/86 rounded-lg shadow-2xl backdrop-blur-md text-white text-xs p-3 select-none max-w-xs transition-all">
      <div
        ...
        <div className="mt-3 space-y-3 pt-2">
          ...
          <div>
            ...
            <div className="space-y-1 text-white/80">
              ...
              <div className="flex items-center gap-2">
                <span className="w-2.5 h-2.5 rounded bg-rose-500/50" />
